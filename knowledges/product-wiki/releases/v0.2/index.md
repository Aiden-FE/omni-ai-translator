...
| **负责人** |  |
| **创建日期** | 2026-07-01 |
| **最近更新** | 2026-07-02（功能事项 1 unified-adapter 完成） |
...
|---|---|---|---|---|---|
| 1 | unified-adapter | P0 | `./1-unified-adapter/PRD.md` | done | 抽象统一翻译源接口，将现有 LLM 适配迁移为 provider 之一，新增传统翻译 provider 抽象，对上层暴露一致接口 |
