...
| **负责人** |  |
| **创建日期** | 2026-07-01 |
| **最近更新** | 2026-07-02（功能事项 4 source-picker-ui #16 完成，PR 待合并） |
...
| 4 | source-picker-ui | P0 | `./4-source-picker-ui/PRD.md` | done | 配置页翻译源选择 UI：源类型选择、当前生效源展示、连通性测试扩展；研发任务 #16 完成，PR 待合并 |
