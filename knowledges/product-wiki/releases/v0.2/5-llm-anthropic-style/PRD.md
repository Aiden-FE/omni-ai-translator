...
| 关联材料 | [../../../startup-summary.md](../../../startup-summary.md)、[../../strategy/index.md](../../strategy/index.md)、[../../roadmap/index.md](../../roadmap/index.md)、[../index.md](../index.md)、[../1-unified-adapter/PRD.md](../1-unified-adapter/PRD.md)、[../../../adr/001-unified-translator-adapter-layer.md](../../../adr/001-unified-translator-adapter-layer.md) |
...
v0.2 已建立统一翻译源适配层（功能事项 1，[ADR-001](../../../adr/001-unified-translator-adapter-layer.md)）：LLM 类源（`openai-compatible` / `ollama`）经 `shared/translator/llm-provider.ts` 的 `createLLMProvider` 接入，`callOpenAICompatible` 按 OpenAI Chat Completions 格式构建请求（`Authorization: Bearer`、`messages` 数组）并解析 `data.choices[0].message.content`。`shared/llm.ts` 已降级为 `@deprecated` 兼容层，内部委托适配层。
...
本 PRD 在配置页源卡片内新增一个「响应风格」单选，无独立新界面，沿用现有配置页设计系统（见 [knowledges/ux/design-system.md](../../../../ux/design-system.md)「提供方卡片」、输入框/单选样式）。不单独产出视觉原型；UI 差异仅体现为源卡片内条件渲染一组单选按钮。详见下文「UX 设计」章节。
...
- 版本: v0.2
- 知识来源: [knowledges/ux/interaction-patterns.md](../../../../ux/interaction-patterns.md)（设置页翻译源管理）、[knowledges/ux/design-system.md](../../../../ux/design-system.md)（提供方卡片、输入框/单选、间距）、[knowledges/ux/accessibility.md](../../../../ux/accessibility.md)（对比度、非颜色依赖、label 关联）
