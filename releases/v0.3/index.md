...
| **负责人** |  |
| **创建日期** | 2026-07-07 |
| **最近更新** | 2026-07-07（sprint-open 完成 + 产品名定稿：脚手架推送 master @ 435214b/aa5521a；里程碑 #2 due 2026-07-29；7 PRD Issue #49-55；UX 章节已补全；产品名定稿 Omni AI Translator(#53)，manifest.name + README 已同步，UI/商店名随 #49/#54 落地，CWS+商标正式检索待完成） |
...
|---|---|---|---|---|---|
| 1 | ui-rewrite | P0 | `./1-ui-rewrite/PRD.md` | draft | 引入 tailwindcss + shadcn/ui，重构翻译浮层/触发按钮/options 配置页/popup 全套组件到新设计系统；划词与配置链路全部基于新组件系统渲染 |
...
| 6 | store-listing | P1 | `./6-store-listing/PRD.md` | draft | 商店 Listing 素材：图标/截图/描述/分类/关键词（截图依赖 1-2）；商店页面具备上架素材 |
| 7 | cross-browser-build | P1 | `./7-cross-browser-build/PRD.md` | draft | WXT 打通 Firefox/Edge 构建 + 上架（依赖 3）；同一流水线产出三浏览器包并上架 |
